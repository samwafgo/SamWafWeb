...
export default {
  ...
  page: {
    ...
    host: {
      ...
      response_compress: {
        intro: "在反代链路上对上游未压缩的响应按条件进行 Gzip/Brotli 压缩（类似 nginx gzip）。上游已带 Content-Encoding 时不会二次压缩。",
        is_enable: "启用响应压缩",
        disable: "关闭",
        enable: "开启",
        prefer: "压缩算法偏好",
        prefer_tips: "br_first：客户端支持则优先 Brotli，否则 Gzip；gzip_only / br_only 仅使用对应算法。",
        prefer_br_first: "优先 Brotli，否则 Gzip",
