...
export default {
  ...
  page: {
    ...
    host: {
      ...
      response_compress: {
        intro: "Compress uncompressed upstream responses with Gzip/Brotli when rules match (similar to nginx gzip). Responses that already have Content-Encoding are not double-compressed.",
        is_enable: "Enable response compression",
        disable: "Off",
        enable: "On",
        prefer: "Algorithm preference",
        prefer_tips: "br_first: prefer Brotli when client supports it, else Gzip; gzip_only / br_only restrict to one algorithm.",
        prefer_br_first: "Prefer Brotli, else Gzip",
