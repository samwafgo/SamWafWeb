      ...
      <div slot="body">
        <t-form :data="formData" ref="form" :rules="rules" @submit="onSubmit" :labelWidth="100">
                      ...
                      <t-form-item :label="$t('page.ca_server_info.ca_server_name')" name="ca_server_name">
                         <t-input :style="{ width: '480px' }" v-model="formData.ca_server_name" ></t-input>
                    </t-form-item>
    ...
    <t-dialog :header="$t('common.edit')" :visible.sync="editFormVisible" :width="680" :footer="false">
      <div slot="body">
        <t-form :data="formEditData" ref="form" :rules="rules" @submit="onSubmitEdit" :labelWidth="100">
                        ...
                        <t-form-item :label="$t('page.ca_server_info.ca_server_name')" name="ca_server_name">
                           <t-input :style="{ width: '480px' }" v-model="formEditData.ca_server_name" ></t-input>
                      </t-form-item>
    ...
    methods: {
      ...
      onSubmit({
        ...
        if (!firstError) {
          ...
          wafCaServerInfoAddApi({...postdata})
            .then((res) => {
              let resdata = res
              console.log(resdata)
              if (resdata.code === 0) {
      ...
      onSubmitEdit({
        ...
        if (!firstError) {
          ...
          wafCaServerInfoEditApi({...postdata})
            .then((res) => {
              let resdata = res
              console.log(resdata)
              if (resdata.code === 0) {
